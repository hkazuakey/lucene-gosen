...
//  }
//
//  private SenFactory(String dictionaryDir, String userDictionaryPath) throws IOException {
...
//  }
  ...
  /**
   * Builds a TokenizerBase for the given dictionary configuration
   *
   * @param dictionaryDir           The dictionary configuration filename
   * @param tokenizeUnknownKatakana
   * @return The constructed TokenizerBase
   */
//  private static TokenizerBase getTokenizer(String dictionaryDir, boolean tokenizeUnknownKatakana) {
//    return getTokenizer(dictionaryDir, null, tokenizeUnknownKatakana);
//  }
//
//  private static TokenizerBase getTokenizer(String dictionaryDir, String userDictionaryDir, boolean tokenizeUnknownKatakana) {
//    SenFactory localInstance = SenFactory.getInstance(dictionaryDir, userDictionaryDir);
//
//    return new SenTokenizer(
//        new Dictionary(
