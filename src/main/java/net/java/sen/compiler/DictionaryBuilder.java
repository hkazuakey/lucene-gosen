...
public class DictionaryBuilder {
   ...
   */
  private static final String BOS_DEFAULT_PART_OF_SPEECH = "文頭,*,*,*,*,*,*";
  
  /**
   * End-of-string token part-of-speech
   */
  private static final String EOS_DEFAULT_PART_OF_SPEECH = "文末,*,*,*,*,*,*";
  
  /**
   * Unknown token part-of-speech
   */
  private static final String UNKNOWN_DEFAULT_PART_OF_SPEECH = "名詞,サ変接続,*,*,*,*,*";
  ...
  public DictionaryBuilder(String[] customDictionaryCSVFilenames) throws IOException {
    ...
    try {
      ...
      createPartOfSpeechDataFile(
          ...
          PART_OF_SPEECH_SIZE,
          charset,
          BOS_DEFAULT_PART_OF_SPEECH,
          EOS_DEFAULT_PART_OF_SPEECH,
          UNKNOWN_DEFAULT_PART_OF_SPEECH,
          dictionaryList,
          standardCTokens
      );
