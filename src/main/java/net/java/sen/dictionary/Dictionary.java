...
public abstract class Dictionary {
   ...
   */
  private ByteBuffer partOfSpeechInfoBuffer;
  ...
  public String getPosIndex(final int index) {
    return posIndex[index];
  }

  public String getConjTypeIndex(final int index) {
    return conjTypeIndex[index];
  }

  public String getConjFormIndex(final int index) {
    return conjFormIndex[index];
  }
  ...
  public void loadSenDictionary(ShortBuffer connectionCostBuffer,
  ...
  InputStream getInputStream(String name, String dictionaryDir) throws IOException {
    InputStream in = null;
  ...
  ByteBuffer loadBuffer(String resource, int size, String dictionaryDir) throws IOException {
    InputStream in = null;
    try {
